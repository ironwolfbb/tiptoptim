      ...
      <div class="wrap w-100">
        <div class="wrap__inner">
          <div class="wrap__heading heading d-flex align-items-center justify-content-between flex-wrap w-100">
            <h1 class="heading__title flex-grow">Рекламная кампания<br> «Аптека доброго здоровьица»</h1>
          </div>
          ...
          <div class="promo-page__content">
            <div class="promo-page__content-item">
              <div class="f-row">
                ...
                <div class="f-col-lg-9">
                  <div class="promo-page__content-text">Аптечная сеть «Фармленд» </div>
                </div>
              </div>
            </div>
            <div class="promo-page__content-item">
              <div class="f-row">
                ...
                <div class="f-col-lg-9">
                  <div class="promo-page__content-text">Разработать и реализовать рекламную кампанию для аптечной сети «Фармленд».</div>
                </div>
              </div>
            </div>
            <div class="promo-page__content-item">
              <div class="f-row">
                ...
                <div class="f-col-lg-9">
                  <div class="promo-page__content-text">
                    <div>1. Выбрать и использовать в кампании амбассадора, отвечающего запросам целевой аудитории (женщины 50+ лет);</div> 
                    <div>2. Представить в рекламе идею здорового образа жизни, бодрости духа и бесконечного позитива; </div> 
                    <div>3. Усилить лояльность клиентов, сформировав образ «своей, родной, простой и доступной аптеки». </div> 
                  </div>
                </div>
              </div>
            </div>
            <div class="promo-page__content-item">
              <div class="f-row">
                ...
                <div class="f-col-lg-9">
                  <div class="promo-page__content-text">
                    <p>В данной кампании мы решили уйти от классического образа врача в рекламе аптеки и показать не лечение болезней, а ведение здорового образа жизни, с помощью которого эти болезни можно избежать.</p>
                    <p>Наша рекламная кампания не про негатив и избавление от болей, а про позитивный и активный лайфстайл. Поэтому лицом компании был выбран Геннадий Малахов — автор оригинальных методик по оздоровлению, популярный ведущий передачи «Доброго здоровьица!» на Первом канале. Малахов — олицетворение бодрости тела и духа, здоровой и счастливой жизни. </p>
                    <p>На основе концепции его передачи родилась идея рекламной кампании «Аптека доброго здоровьица».</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="promo-page__content-item">
              <div class="f-row">
                ...
                <div class="f-col-lg-9">
                  <div class="promo-page__content-text">
                  В рамках кампании был разработан имиджевый ролик, промо-ролики и наружная реклама.
                  </div>
                </div>
              </div>
            </div>
